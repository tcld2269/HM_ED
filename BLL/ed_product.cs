...
namespace hm.BLL
{
	...
	{
		private readonly hm.DAL.ed_product dal=new hm.DAL.ed_product();
		public ed_product()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public hm.Model.ed_product GetModelByCache(int ID)
		{
			
			string CacheKey = "ed_productModel-" + ID;
			...
			return (hm.Model.ed_product)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<hm.Model.ed_product> GetModelList(string strWhere)
		{
