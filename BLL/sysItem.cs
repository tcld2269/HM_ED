		...
		public List<hm.Model.sysItem> DataTableToList(DataTable dt)
		{
			...
			if (rowsCount > 0)
			{
				...
				for (int n = 0; n < rowsCount; n++)
				{
					...
					if(dt.Rows[n]["col1"]!=null && dt.Rows[n]["col1"].ToString()!="")
					{
					model.col1=dt.Rows[n]["col1"].ToString();
					}
					if(dt.Rows[n]["col2"]!=null && dt.Rows[n]["col2"].ToString()!="")
					{
					model.col2=dt.Rows[n]["col2"].ToString();
					}
					if(dt.Rows[n]["col3"]!=null && dt.Rows[n]["col3"].ToString()!="")
					{
					model.col3=dt.Rows[n]["col3"].ToString();
					}
					if(dt.Rows[n]["col4"]!=null && dt.Rows[n]["col4"].ToString()!="")
					{
						model.col4=int.Parse(dt.Rows[n]["col4"].ToString());
					}
					modelList.Add(model);
				}
			}
