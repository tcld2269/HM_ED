...
namespace hm.Common
{
    public static class CommonHelper
    {
        ...
        public static void bindNodeTypes(DropDownList ddl)
        {
            ddl.Items.Clear();
            ddl.Items.Add(new ListItem("新闻", "1"));
            ddl.Items.Add(new ListItem("单页", "2"));
            ddl.Items.Add(new ListItem("产品", "3"));
            ddl.Items.Add(new ListItem("综合", "4"));
        }
